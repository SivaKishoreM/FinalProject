...
namespace EventManagements.Controllers
{
    public class Tablebookvenues2Controller : Controller
    {
        ...
        // GET: Tablebookvenues2/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: Tablebookvenues2/Create
        ...
        // POST: Tablebookvenues2/Delete/5
