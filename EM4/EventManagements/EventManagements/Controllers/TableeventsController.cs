...
{
    public class TableeventsController : Controller
    {
        ...
        // GET: Tableevents/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: Tableevents/Create
